...
class NetworkInfoProvider constructor(private val context: Context,
    ...
    init {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP && connectivityManager != null) {
            ...
            try {
                ContextCompat.registerReceiver(context, networkChangeBroadcastReceiver, IntentFilter(ConnectivityManager.CONNECTIVITY_ACTION), ContextCompat.RECEIVER_EXPORTED)
